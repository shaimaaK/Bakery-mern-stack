...
const UpdateProfileScreen = () => {
    ...
    const accountUpdate = () => {
        ...
        // 1.2 If the fields are valid, setState("sending")
            ...
            console.log()
            fetch(
                `${process.env.REACT_APP_BACKEND}/user/update-profile`,
                {
                    method: 'POST',
                    body: formData
                }
    ...
    return (
        <form className="container">
            <h2 style={{ 'margin-top': '150px', 'color': 'black', 'text-align': 'center' }}>Update Your Profile</h2>
            <div className="container">
                <div className="row d-flex justify-content-center">
                    <div className="card shadow-lg col-xl-8 col-lg-8 col-md-8 col-sm-12 col-12 m-5 p-5">
                        ...
                        {
                            accountState === "idle" && <button onClick={accountUpdate} className="btn btn-primary"><span style={{ 'font-weight': 'bold' }}>UPDATE ACCOUNT</span></button>
                        }
                        {
                            accountState === "sending" && <p>Please Wait untill the account is updated successfully....... </p>
                        }
                        {
                            (accountState === "successful") &&
                            <div>
                                <button onClick={accountUpdate} className="btn btn-primary col-12"><span style={{ 'font-weight': 'bold' }}>UPDATE ACCOUNT</span></button>
                                <div class="alert alert-success mt-2">Account Updated Successfully</div>
                            </div>
                        }
                        {
